...
const gems = [
  ...
  { src: silkInclusion, name: "Heated Yellow Sapphire Snowball", desc: "A little snowball in the center with heated fingerprint patterns swirling around it, rounded inclusions with soft halos" },
  { src: jellyfishInclusion, name: "Blue Sapphire Mushroom Inclusion", desc: "Heated fingerprint inclusion shaped like a glowing mushroom with smooth cap, gill-like details and a faint stem, Madagascar origin" },
