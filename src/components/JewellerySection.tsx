    ...
    categories: [
      {
        ...
        pieces: [
          ...
          { src: emeraldRing, name: "Tsavorite - 4 Carat", desc: "CUSTOM MADE · Yellow Gold · 4ct Tsavorite · Diamond Halo" },
          { src: blueSapphireRing, name: "Blue Sapphire - 3 Carat", desc: "Rose Gold · 3ct Blue Sapphire · Round & Marquise Diamonds" },
          { src: sapphireTrilogyRing, name: "Ceylon Sapphire", desc: "Yellow Gold · Oval Blue Sapphire · Round Brilliant Diamonds" },
          { src: aquamarineMarquiseRing, name: "Aquamarine", desc: "Platinum · Marquise Aquamarine · Tapered Baguette Diamonds" },
          { src: zultaniteSolitaireRing, name: "Tourmaline", desc: "Yellow Gold · Tourmaline · Four-Prong Setting" },
          { src: multiSapphireStackingRings, name: "Multi-Sapphire", desc: "Yellow Gold · Bezel-Set Sapphires · Mixed Fancy Cuts" },
          { src: sapphireStarburstRing, name: "Blue Sapphire", desc: "White Gold · Oval Blue Sapphire · Diamond Sunburst Halo" },
          { src: yellowSapphireHaloRing, name: "Yellow Sapphire - 4.5 Carat", desc: "CUSTOM MADE · Yellow Gold · 4.5ct Vivid Yellow Sapphire · Dazzling Diamonds" },
          { src: sapphirePaveBandRingV2, name: "Royal Blue Sapphire", desc: "White Gold · Royal Blue Sapphire · Diamonds" },
          { src: sapphireFloralBypassRingV2, name: "Blue Sapphires", desc: "White Gold · Calibrated Blue Sapphires · Diamond Floral Settings" },
          { src: aquamarineDiamondEternityRingV2, name: "Aquamarine & White Sapphire", desc: "CUSTOM MADE · Yellow Gold · White Sapphires · Pale Aquamarines" },
          { src: laksanaTsavoriteSapphireBandsV2, name: "Tsavorite & Sapphire", desc: "White Gold · Calibré Tsavorites & Sapphires · Shared-Prong Set" },
          { src: rhodoliteHaloCocktailRingV2, name: "Rhodolite", desc: "White Gold · Emerald-Cut Rhodolite · Diamond Halo" },
          { src: greenTourmalineDiamondHaloRingV2, name: "Green Tourmaline", desc: "White Gold · Oval Green Tourmaline · Asymmetric Diamond Halo" },
          { src: pinkTourmalineRing, name: "Pink Tourmaline", desc: "Yellow Gold · Pink Tourmaline · Diamond Clusters" },
          { src: aquamarineHaloRing, name: "Aquamarine - 7 Carat", desc: "18kt White Gold · 7ct Aquamarine · Green Tourmalines" },
          { src: aquamarineTrilogyRing, name: "Aquamarine & Green Tourmaline", desc: "18kt White Gold · Aquamarine · Green Tourmaline" },
          
          { src: morganiteRing, name: "Morganite", desc: "White Gold · Morganite · Diamond Setting" },
          { src: whiteSapphireRing, name: "White Sapphire", desc: "White Gold · Oval White Sapphire · Diamond Sunburst Halo" },
          { src: tourmalineRing, name: "Green Tourmalines", desc: "Yellow Gold · Emerald-Cut Green Tourmalines · Mixed Gems" },
          { src: pinkSapphireRingJewel, name: "Pink Sapphire", desc: "Yellow & White Gold · Cushion Pink Sapphire · Filigree Setting" },
          { src: tourmalineSignetRing, name: "Tourmaline", desc: "Yellow Gold · Emerald-Cut Tourmaline · Brushed Finish" },
          { src: sapphireTopazAmethystRing, name: "Sapphire, Topaz & Amethyst", desc: "CUSTOM MADE · Rose Gold · Blue Sapphires · Blue Topaz · Amethyst · Moonstones" },
          { src: garnetDiamondHaloRing, name: "Garnet", desc: "Rose Gold · Trillion Garnet · Diamond Halo & Pavé" },
          { src: diamondPaveWideBand, name: "Diamonds", desc: "Rose Gold · Round Brilliant Diamonds · Five-Row Pavé" },
          { src: tricolorDiamondEternityBands, name: "Diamonds", desc: "Rose, White & Yellow Gold · Round Brilliant Diamonds · Stacking Set" },
          { src: tricolorDiamondEternityRings, name: "Diamonds", desc: "Rose, White & Yellow Gold · Diamond Eternity · Shared-Prong Set" },
          { src: [alexandriteRingGreen, alexandriteRingPink], name: "Alexandrite - 5 Carat", desc: "CUSTOM MADE · White Gold · 5ct Colour-Change Alexandrite · Diamond Starburst Halo" },
          { src: [whiteSapphireCocktail1, whiteSapphireCocktail2], name: "White Sapphire - 19 Carat", desc: "CUSTOM MADE · White Gold · 19ct White Sapphire · Princess-Cut Diamonds" },
          { src: [rubyCocktail1, rubyCocktail2], name: "Unheated Ruby - 4 Carat", desc: "CUSTOM MADE · White Gold · 4ct Unheated Ruby · Baguette & Round Diamonds" },
          { src: spessartineGarnetRing, name: "Spessartine Garnet - 9 Carat", desc: "CUSTOM MADE · White Gold · 9ct Spessartine Garnet · Double Diamond Halo" },
          { src: starSapphireRing, name: "Star Sapphire - 10 Carat", desc: "CUSTOM MADE · Yellow Gold · 10ct Star Sapphire · Beaded Bezel Setting" },
          { src: greenSapphireArtDecoRing, name: "Green Sapphire", desc: "CUSTOM MADE · Yellow Gold · Cushion Green Sapphire · Baguette & Round Diamonds" },
          { src: kunzitePinkSapphireRing, name: "Kunzite & Pink Sapphire", desc: "CUSTOM MADE · White Gold · Oval Kunzite Cabochon · Pink Sapphire Accents" },
          { src: greenSapphireByzantineRing, name: "Green Sapphire - 2 Carat", desc: "CUSTOM MADE · Yellow Gold · 2ct Green Sapphire · Hot Pink Sapphires · Rope Detail" },
          { src: greenSapphireWhiteSapphireRing, name: "Green Sapphire - 3 Carat", desc: "CUSTOM MADE · White Gold · 3ct Green Sapphire · Two White Sapphires · Rope Detail" },
          { src: tealSapphireLoveRing, name: "Teal & Green Sapphire", desc: "CUSTOM MADE · Yellow Gold · Teal Sapphires · Green Sapphires · Script Band" },
          { src: [blueSapphireDomeRing, blueSapphireDomeRing2], name: "Blue Sapphire - 7 Carat", desc: "CUSTOM MADE · White Gold · 7ct Blue Sapphire · Diamond Filigree Setting" },
          { src: diamondClusterGoldRing, name: "Diamonds", desc: "CUSTOM MADE · Yellow Gold · Diamond Floral Cluster · Pavé Band" },
          { src: whiteSapphireEmeraldRing, name: "White Sapphire & Emerald - 2 Carat", desc: "CUSTOM MADE · Yellow Gold · 2ct White Sapphire · Two Emeralds · Diamonds" },
          { src: triSapphireHammeredRing, name: "Blue, Green & Pink Sapphire", desc: "CUSTOM MADE · Yellow Gold · Blue Sapphire · Green Sapphire · Pink Sapphire · Hammered Finish" },
          { src: [orangeSapphireHaloRing1, orangeSapphireHaloRing2], name: "Orange Sapphire - 12 Carat", desc: "CUSTOM MADE · White Gold · 12ct Orange Sapphire · Dazzling Diamonds" },
          { src: [tsavoriteDiamondRing1, tsavoriteDiamondRing2], name: "Tsavorite - 8.07 Carat", desc: "CUSTOM MADE · White Gold · 8.07ct Tsavorite · Dazzling Diamonds" },
          { src: goldenYellowSapphireRing, name: "Golden Yellow Sapphire - 8 Carat", desc: "CUSTOM MADE · Yellow Gold · 8ct Golden Yellow Sapphire · Dazzling Diamonds" },
          { src: tanzaniteDiamondRing, name: "Tanzanite", desc: "CUSTOM MADE · Yellow Gold · Tanzanite · Dazzling Diamonds" },
          { src: blueSapphireDiamondRing, name: "Blue Sapphire - 3 Carat", desc: "CUSTOM MADE · White Gold · 3ct Oval Blue Sapphire · Dazzling Diamonds" },
        ],
      },
      {
        category: "Earrings",
        pieces: [
          { src: rubyDiamondStuds, name: "Rubies & Diamonds", desc: "CUSTOM MADE · White Gold · Rubies · Diamond Openwork Lattice" },
          { src: pinkTourmalineDropEarrings, name: "Pink Tourmaline", desc: "White Gold · Oval Pink Tourmaline · Diamond Halo & Pavé" },
          { src: tsavoriteDropEarrings, name: "Tsavorite", desc: "Yellow Gold · Oval Tsavorite · Diamond Sunburst Halo" },
          { src: diamondChandelierEarrings, name: "Diamonds", desc: "White Gold · Round Brilliant Diamonds · Milgrain Openwork" },
          { src: sapphireDoubleHaloStudsV2, name: "Blue & Yellow Sapphires", desc: "Yellow Gold · Blue Sapphires · Yellow Sapphires" },
          { src: pinkTourmalineSunburstEarringsV2, name: "Pink Sapphires", desc: "Yellow Gold · Oval Pink Sapphires · Baguette Diamond Rays" },
          { src: tsavoriteStarburstDropEarringsV2, name: "Tsavorites", desc: "White Gold · Oval Tsavorites · Diamond Starburst Frames" },
          { src: pinkTourmalineLaceDropEarrings, name: "Pink Tourmalines", desc: "White Gold · Oval Pink Tourmalines · Diamond Lace Openwork" },
          { src: greenTourmalineDropEarrings, name: "Green Tourmalines", desc: "Yellow Gold · Emerald-Cut Green Tourmalines · Diamond Studs" },
          { src: pinkSapphireHoops, name: "Pink Sapphires", desc: "Rose Gold · Pink Sapphires · Inside-Out Setting" },
          { src: sapphireEarrings, name: "Blue Sapphires", desc: "White Gold · Blue Sapphires · Double Diamond Halo" },
          { src: aquamarineEarrings, name: "Aquamarine", desc: "Yellow Gold · Aquamarine · Diamonds" },
          { src: tourmalinePearDropEarrings, name: "Pink & Green Tourmalines", desc: "White Gold · Pear Pink & Green Tourmalines · Diamond Halo" },
          { src: sapphireCircleDropEarrings, name: "Blue Sapphires - 3 Carat", desc: "CUSTOM MADE · White Gold · 3ct Blue Sapphires · Diamond Circle Frames" },
          { src: multiGemLatticeHoops, name: "Sapphires, Rubies & Aquamarines", desc: "CUSTOM MADE · Yellow Gold · Sapphires · Rubies · Aquamarines · Cabochon Setting" },
          { src: tanzaniteDiamondEarrings1, name: "Tanzanites & Diamonds", desc: "White Gold · Tanzanites · Dazzling Diamonds" },
          { src: tsavoriteDiamondEarrings, name: "Tsavorites & Diamonds", desc: "White Gold · Tsavorites · Dazzling Diamonds" },
          { src: blueSapphireDiamondEarrings, name: "Blue Sapphires & Diamonds", desc: "White Gold · Blue Sapphires · Dazzling Diamonds" },
          { src: tanzaniteDiamondEarrings2, name: "Tanzanites & Diamonds", desc: "Yellow Gold · Tanzanites · Dazzling Diamonds" },
          { src: tourmalineEarrings1, name: "Tourmalines", desc: "Yellow Gold · Heart-Cut Tourmalines · Mixed Gems" },
          { src: tourmalineEarrings2, name: "Multi-Colour Tourmalines", desc: "Yellow Gold · Multi-Colour Tourmalines · Drop Setting" },
          { src: tourmalineEarrings3, name: "Tourmalines", desc: "Yellow Gold · Emerald-Cut Tourmalines · Mixed Colours" },
          { src: tourmalineEarrings4, name: "Tourmalines", desc: "Yellow Gold · Emerald-Cut Tourmalines · Tri-Colour" },
          { src: spinelEarrings, name: "Spinels", desc: "Yellow Gold · Heart & Cushion Spinels · Mixed Colours" },
          { src: blueSapphireDiamondStuds, name: "Blue Sapphires & Diamonds", desc: "Gold · Blue Sapphires · Diamonds" },
          { src: blueSapphireDiamondStuds2, name: "Blue Sapphires & Diamonds", desc: "Gold · Blue Sapphires · Diamonds" },
          { src: tourmalineDiamondDropEarrings, name: "Tourmalines & Diamonds", desc: "Gold · Tourmalines · Diamonds" },
          { src: berylStoneEarrings, name: "Beryl - 16 Carat", desc: "Gold · 16ct Beryl Stones · Diamond Studs" },
          { src: whiteSapphireEarringsImg, name: "White Sapphires", desc: "Gold · White Sapphires · Rose Tones" },
          { src: peridotYellowSapphireEarrings, name: "Peridot & Yellow Sapphire", desc: "Gold · Peridot Pair · Yellow Sapphire Surround" },
          { src: pinkTourmalinePinkSapphireEarrings, name: "Pink Tourmaline & Pink Sapphire", desc: "Gold · Pink Tourmaline · Calibrated Pink Sapphires" },
          { src: multiColourSapphireEarrings, name: "Multi-Colour Sapphires", desc: "Gold · Multi-Colour Sapphires · Chain Drop" },
          { src: yellowSapphireDiamondEarrings, name: "Pale Yellow Sapphire & Diamonds", desc: "Gold · Pale Yellow Sapphires · Diamonds" },
        ],
      },
      {
        category: "Bracelets",
